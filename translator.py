...
two_label = Label(tk_window, text = "\t\t\t\t\t\t", bg = "white", fg = "red",
                  font = ("Arial", 42, "bold"))
two_label.place(x = 0, y = 120)

two_label = Label(tk_window, text = "Translated Language", bg = "white", fg = "red",
                  font = ("Arial", 30, "bold"))
two_label.place(x = 180, y = 140)

translate_b = Button(tk_window, text = "Translate Text", bg = "green", fg = "white",
                     font = ("Arial", 25, "bold"), command = translate_language)
